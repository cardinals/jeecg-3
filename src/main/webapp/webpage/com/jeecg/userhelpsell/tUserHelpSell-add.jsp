...
<t:base type="bootstrap,bootstrap-table,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="tUserHelpSellController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="cartBrand" name="cartBrand" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入品牌"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">

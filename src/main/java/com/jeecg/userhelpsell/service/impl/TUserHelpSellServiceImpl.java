package com.jeecg.userhelpsell.service.impl;
...
@Service("tUserHelpSellService")
@Transactional
public class TUserHelpSellServiceImpl extends CommonServiceImpl implements TUserHelpSellServiceI {

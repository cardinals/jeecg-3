package com.jeecg.reducpricenotic.service.impl;
...
@Service("tReducPriceNoticService")
@Transactional
public class TReducPriceNoticServiceImpl extends CommonServiceImpl implements TReducPriceNoticServiceI {

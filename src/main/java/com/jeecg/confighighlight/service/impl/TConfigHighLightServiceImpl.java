package com.jeecg.confighighlight.service.impl;
...
@Service("tConfigHighLightService")
@Transactional
public class TConfigHighLightServiceImpl extends CommonServiceImpl implements TConfigHighLightServiceI {

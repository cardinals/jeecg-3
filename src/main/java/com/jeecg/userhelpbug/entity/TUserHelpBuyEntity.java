package com.jeecg.userhelpbug.entity;
 ...
 */
@Entity
@Table(name = "t_user_help_buy", schema = "")
@SuppressWarnings("serial")
public class TUserHelpBuyEntity implements java.io.Serializable {
	/**主键*/
	private String id;
	/**创建人名称*/
	...
	@Column(name ="CART_TYPE",nullable=true,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  购买预算
	 */

	@Column(name ="BUY_BUDGET",nullable=true,length=32)

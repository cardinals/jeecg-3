package com.jeecg.userhelpbug.service.impl;
...
@Service("tUserHelpBuyService")
@Transactional
public class TUserHelpBuyServiceImpl extends CommonServiceImpl implements TUserHelpBuyServiceI {

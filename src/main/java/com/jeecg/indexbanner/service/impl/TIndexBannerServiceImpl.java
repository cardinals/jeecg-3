package com.jeecg.indexbanner.service.impl;
...
@Service("tIndexBannerService")
@Transactional
public class TIndexBannerServiceImpl extends CommonServiceImpl implements TIndexBannerServiceI {
